...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "django-html-mode" '("django-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "django-mode" '("django-")))
